<script>
// 导入所有节点组件
import Approval from '@/views/flow/common/process/nodes/ApprovalNode.vue'
import Cc from '@/views/flow/common/process/nodes/CcNode.vue'
import Concurrent from '@/views/flow/common/process/nodes/ConcurrentNode.vue'
import Condition from '@/views/flow/common/process/nodes/ConditionNode.vue'
import Trigger from '@/views/flow/common/process/nodes/TriggerNode.vue'
import Delay from '@/views/flow/common/process/nodes/DelayNode.vue'
import Empty from '@/views/flow/common/process/nodes/EmptyNode.vue'
import Root from '@/views/flow/common/process/nodes/RootNode.vue'
import Node from '@/views/flow/common/process/nodes/Node.vue'
