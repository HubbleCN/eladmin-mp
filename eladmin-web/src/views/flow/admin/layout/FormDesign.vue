...
import FormRender from '@/views/flow/common/form/FormRender'
import FormDesignRender from '@/views/flow/admin/layout/form/FormDesignRender'
import FormComponentConfig from '@/views/flow/common/form/FormComponentConfig'
import { baseComponents } from '@/views/flow/common/form/ComponentsConfigExport'
...
@import '@/assets/styles/wflow.scss';
