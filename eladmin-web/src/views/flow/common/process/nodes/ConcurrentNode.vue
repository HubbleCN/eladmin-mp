<template>
  <div class="node">
    <div class="node-body" @click="$emit('selected')">
      <div v-if="level > 1" class="node-body-left" @click.stop="$emit('leftMove')">
      ...
      <div v-if="level < size" class="node-body-right" @click.stop="$emit('rightMove')">
...
<script>
import InsertButton from '@/views/flow/common/InsertButton.vue'
