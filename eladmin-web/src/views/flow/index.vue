<template>
  <div style="text-align: center">
    ...
    <div class="work-panel">
      <div class="user">
        <el-button type="primary" round size="small" icon="el-icon-user" @click="$refs.orgPicker.show()">选择本次登录者</el-button>
    ...
    <org-picker ref="orgPicker" type="user" :selected="select" @ok="selected" />
  </div>
</template>
